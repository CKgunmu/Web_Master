	...
	<div class="container row">
		...
		<div class="col-12" style="margin-top: 3%; padding-left:20px;">
			<div class="col-12" style="margin-bottom: 1%;">
				<b style="font-size:30px">Hacking 게시글</b> 
			...
			<div class="col-12">
				...
				<?
					$sql = "SELECT * FROM board where category='Hacking'";
					$result = mysqli_query($conn, $sql);

					while ($row = mysqli_fetch_array($result)) {
						echo '<div class="col-12">';
						echo "<div class='col-2'>".$row['user']."</div>";
						echo "<div class='col-9'><a href='view.php?no=".$row['no']."&ti=".$row['title']."&user=".$row['user']."'>".$row['title']."</a></div>";
