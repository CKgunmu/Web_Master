		...
		<div class="col-12" style="margin-top: 3%; padding-left:20px;">
			...
			<form action="write.php" method="POST">
				<div class="col-12 login-form-1">
					...
					<div class="category">
						<input type="text" name="title" class="form-control" placeholder="text title *" value="" />
					</div>
                ...
                <?
                	...
                	if(isset($login) != NULL) {
                		if(isset($user) and isset($title) and isset($cate) and isset($text)) {
                			...
                			if($check_data) {
	                			$sql = "INSERT INTO board(user,title,texts,category) VALUES('$user','$title','$text','$cate')";
